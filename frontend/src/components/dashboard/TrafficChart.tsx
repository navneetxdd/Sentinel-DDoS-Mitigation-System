      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <div className={cn(
            ...
            isAttack ? "bg-status-danger pulse-glow" : "bg-status-success"
          )} />
          <span className={cn(
            "text-xs font-medium",
            isAttack ? "text-status-danger" : "text-status-success"
          )}>
            ...
            <AreaChart data={chartData}>
              <defs>
                <linearGradient id="trafficGradient" x1="0" y1="0" x2="0" y2="1">
                  <stop
                    offset="0%"
                    stopColor={isAttack ? "hsl(0, 62%, 50%)" : "hsl(0, 0%, 70%)"}
                    stopOpacity={0.2}
                  />
                  <stop
                    offset="100%"
              ...
              <Area
                type="monotone"
                dataKey="packets"
                stroke={isAttack ? "hsl(0, 62%, 50%)" : "hsl(0, 0%, 70%)"}
                strokeWidth={2}
